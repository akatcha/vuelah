...
<script>
// This calendar is from codepen (https://codepen.io/peanav/pen/ulkof).
// I ported this calendar to work within vue and populate with dates.
...
export default {
        ...
        calendar() {
            ...
            Calendar.prototype.drawMonth = function() {
                ...
                if (this.month) {
                    ...
                    this.oldMonth.addEventListener(
                        "webkitAnimationEnd",
                        function() {
                ...
                if (
                    ...
                    if (currentOpened) {
                        currentOpened.addEventListener(
                            "webkitAnimationEnd",
                            function() {
                                currentOpened.parentNode.removeChild(
                                    currentOpened
                                );
                            }
                        );
            ...
            Calendar.prototype.renderEvents = function(events, ele) {
                ...
                events.forEach(function(ev) {
                    ...
                    var square = createElement(
                        "div",
                        "event-category " + ev.color
                    );
                ...
                if (currentWrapper) {
                    ...
                    currentWrapper.addEventListener(
                        "webkitAnimationEnd",
                        function() {
                            currentWrapper.parentNode.removeChild(
                                currentWrapper
                            );
    ...
    mounted: function() {
        const RSS_URL = `https://cors-anywhere.herokuapp.com/https://www.lbyc.us/event_rss_feed?tags=3720054`;
        const options = {
            headers: new Headers({
        ...
        fetch(RSS_URL, options)
            .then((response) => response.text())
            .then((str) => {
                return parser.parseStringPromise(str).then(function(result) {
